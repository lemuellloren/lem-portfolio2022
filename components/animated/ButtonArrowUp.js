const ButtonArrowUp = ({ text = 'button text' }) => {
  return (
    <>
      <button className="group relative flex h-12 w-[170px]  items-center justify-between bg-gray-200 rounded-lg dark:bg-zinc-900">
        <p className="pl-4 text-black dark:text-white">{text}</p>
